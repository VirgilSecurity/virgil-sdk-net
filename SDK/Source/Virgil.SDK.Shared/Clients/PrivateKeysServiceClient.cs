namespace Virgil.SDK.Clients
{
    ...
    internal class PrivateKeysServiceClient : EndpointClient, IPrivateKeysServiceClient
    {
        ...
        //    await this.Send(request).ConfigureAwait(false);
        //}
        public Task Stash(Guid cardId, byte[] privateKey, string privateKeyPassword = null)
        {
        ...
        public Task<PrivateKeyModel> Get(Guid cardId, IdentityInfo identityInfo, string responsePassword)
        {
            throw new NotImplementedException();
        }

        public Task Destroy(Guid cardId, byte[] privateKey, string privateKeyPassword = null)
        {
            throw new NotImplementedException();
        }
    }
