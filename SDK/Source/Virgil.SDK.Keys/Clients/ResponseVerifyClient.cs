namespace Virgil.SDK.Clients
{
    ...
    public abstract class ResponseVerifyClient : EndpointClient
    {
        ...
        {
            var response = await this.Connection.Send(request);
            var virgilCardDto = await this.Cache.GetServiceCard(this.EndpointApplicationId);
        ...
        /// Initializes a new instance of the <see cref="ResponseVerifyClient"/> class.
        /// </summary>
        /// <param name="cache">The connection.</param>
