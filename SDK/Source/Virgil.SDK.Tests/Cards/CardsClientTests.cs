namespace Virgil.SDK.Keys.Tests.Cards
{
    ...
    public class CardsClientTests
    {
        ...
        public async void Test1()
        {
            ...
            var newCard = await serviceHub.Cards.PublishAsGlobalAsync(ticket);

            var globalCards = await serviceHub.Cards.SearchGlobalAsync("demo@virgilsecurity.com", IdentityType.Email);
            var privateCards = await serviceHub.Cards.SearchPrivateAsync("denis", "user_name", true);
