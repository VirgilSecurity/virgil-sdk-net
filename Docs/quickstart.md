...
The app is merging the message text and the signature into one [structure](#https://github.com/VirgilSecurity/virgil-sdk-net/blob/master/Examples/Virgil.Examples.IPMessaging/EncryptedMessageModel.cs) and sending the message to the channel using a simple IP messaging client.
